...
```bash
python -m src.train --small --max-samples 10000 --epochs 1 --batch-size 8 --output-dir ./checkpoints
```
...
```bash
python -m src.inference --checkpoint ./checkpoints/best --text "Dzień dobry. Jak się masz?"
```
